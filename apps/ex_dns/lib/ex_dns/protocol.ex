...
# ---
defmodule ExDns.Protocol do
  alias ExDns.Protocol.{Answer, Header, Question}
  ...
  Decodes a DNS header.
      ...
      iex> ExDns.Protocol.decode_header(header)
  ...
  def decode_question(binary) do
    {qname, <<qtype::16, qclass::16, rest::binary>>} = decode_strings(binary)

    {%Question{qname: qname, qtype: decode_type(qtype), qclass: qclass}, rest}
  end
  ...
  Encode a sequence of strings.
      ...
      iex> iodata = ExDns.Protocol.encode_strings(["elixir-lang", "org"])
